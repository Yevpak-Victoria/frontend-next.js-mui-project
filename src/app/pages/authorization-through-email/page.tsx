            ...
            <Box sx={{mt: 3}}>
                ...
                <CustomBox>
                    <Typography variant='h4' sx={{ textAlign: "center", pt:2, pb: 1 }}>
                        Завершіть створення свого облікового запису для повного використання </Typography>
                    <SetOfCustomInputs/>

                    <Button variant='contained' color='secondary'
                            sx={{textTransform: 'none', fontWeight: 400, borderRadius: '30px', mt: 1, width: '20vh', boxShadow: 0}}
                    >Створити</Button>
                    <Footnote/>
                </CustomBox>
